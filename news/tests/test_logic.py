...
class TestCommentCreation(TestCase):
    """Класс тестов создания комментария."""
    ...
    def test_user_can_create_comment(self):
        """Авторизированный пользователь может создать комментарий."""
...
class TestCommentEditDelete(TestCase):
    """Класс тестов изменения и удаления комментария."""
    ...
    def test_author_can_delete_comment(self):
        """Тест удаление комментария автором."""
    ...
    def test_author_can_edit_comment(self):
        """Тест изменения комментария автором."""
